...
//    public String stsURI = "http://localhost:9998/tokenservice/";
	...
	private void addATestUser(int i) {
        UserAggregate ua = new UserAggregate("j" +
                "m_uid-" + i, "m_username " + Character.getName(i), "firstName" + Character.getName(i), "lastName" + Character.getName(i), "personRef" + i, "tester" + i + "@whydah.com", String.valueOf(RandomUtils.nextInt(1000000000)));
